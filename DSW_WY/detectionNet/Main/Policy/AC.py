...
class EncoderCNN(nn.Module):
    def __init__(self, n_class=_C.NUM_CLASSES2, input_size=_C.IMAGE_SIZE2, width_mult=1.):
...
def encodercnn():
    ...
    model.load_state_dict(torch.load(os.path.join(_C.MOBILE_TRAINED_DIR,_C.MOBILE_PICK)))
    return model
